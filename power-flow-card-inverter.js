    ...
    const schema = [
        ...
        selector: {
          select: {
		   ...
		   //----CẤU HÌNH CHUNG -----
            ...
            { name: "always_show_aux", label: "Luôn hiển thị cổng AUX", selector: { boolean: {} } },
            { name: "invert_aux_power", label: "Đảo chiều công suất cổng AUX", selector: { boolean: {} } },
            { name: "smart_load_aux", label: "AUX là Tải tiêu thụ", selector: { boolean: {} } },
		  ...
		  // --- Biến tần (Inverter) ---
            ...
            { name: "inverter_x", label: "Tọa độ X Biến tần (Inverter X coordinate-Default: 132)", selector: { number: { min: 0, max: 800, step: 1, mode: "box" } } },
            { name: "inverter_y", label: "Tọa độ Y Biến tần (Inverter Y coordinate-Default: 78)", selector: { number: { min: 0, max: 800, step: 1, mode: "box" } } },
          ...
          // --- Điện mặt trời (PV) ---
            ...
            { name: "pv_x", label: "Tọa độ X PV (pv X coordinate-Default: 138)", selector: { number: { min: 0, max: 800, step: 1, mode: "box" } } },
            { name: "pv_y", label: "Tọa độ Y PV (pv Y coordinate-Default: -56)", selector: { number: { min: 0, max: 800, step: 1, mode: "box" } } },
            { name: "pv_width", label: "Chiều rộng hình ảnh (Image width-Default: 50)", selector: { number: { min: 0, max: 800, step: 1, mode: "box" } } },
            { name: "pv_height", label: "Chiều cao hình ảnh (Image height-Default: 50)", selector: { number: { min: 0, max: 800, step: 1, mode: "box" } } },
          ...
          // --- Tải tiêu thụ nhà (Load) ---
            ...
            { name: "load_x", label: "Tọa độ X TIÊU THỤ (load X coordinate-Default: 100)", selector: { number: { min: 0, max: 800, step: 1, mode: "box" } } },
            { name: "load_y", label: "Tọa độ Y TIÊU THỤ (load Y coordinate-Default: 92)", selector: { number: { min: 0, max: 800, step: 1, mode: "box" } } },
            { name: "load_width", label: "Chiều rộng hình ảnh (Image width-Default: 0)", selector: { number: { min: 0, max: 800, step: 1, mode: "box" } } },
            { name: "load_height", label: "Chiều cao hình ảnh (Image height-Default: 0)", selector: { number: { min: 0, max: 800, step: 1, mode: "box" } } },
          ...
          // --- Tải dự phòng (EPS / Backup Load) ---
            ...
            { name: "eps_x", label: "Tọa độ X Biến tần (UPS X coordinate-Default: 0)", selector: { number: { min: 0, max: 800, step: 1, mode: "box" } } },
            { name: "eps_y", label: "Tọa độ Y Biến tần (UPS Y coordinate-Default: 0)", selector: { number: { min: 0, max: 800, step: 1, mode: "box" } } },
            { name: "eps_width", label: "Chiều rộng hình ảnh (Image width-Default: 50)", selector: { number: { min: 0, max: 800, step: 1, mode: "box" } } },
            { name: "eps_height", label: "Chiều cao hình ảnh (Image height-Default: 50)", selector: { number: { min: 0, max: 800, step: 1, mode: "box" } } },
			
          // --- Tải phụ / Smart Load (AUX) ---
            { name: "aux_image", label: "Bật tùy chỉnh ảnh UPS (Set true to use custom image)", selector: { boolean: {} } },
            { name: "aux_icon", label: "Icon UPS (aux icon)", selector: { icon: {} } },
            { name: "aux_icon", label: "Tùy chỉnh ảnh UPS (Đường dẫn / URL-aux image)", selector: { text: {} } },
            { name: "aux_x", label: "Tọa độ X UPS (aux X coordinate-Default: 274)", selector: { number: { min: 0, max: 800, step: 1, mode: "box" } } },
            { name: "aux_y", label: "Tọa độ Y UPS (aux Y coordinate-Default: -58)", selector: { number: { min: 0, max: 800, step: 1, mode: "box" } } },
            { name: "aux_width", label: "Chiều rộng hình ảnh (Image width-Default: 44)", selector: { number: { min: 0, max: 800, step: 1, mode: "box" } } },
            { name: "aux_height", label: "Chiều cao hình ảnh (Image height-Default: 46)", selector: { number: { min: 0, max: 800, step: 1, mode: "box" } } },
			...
			
      {
        ...
        schema: [
                    ...
                    // --- Hoà lưới / Máy phát (AC PV) ---
                    { name: "aux_power", label: "Hoà lưới/Máy phát Công suất - AC PV/Generator Power", selector: entitySelector },
                    { name: "aux_voltage", label: "Hoà lưới/Máy phát Điện áp - AC PV/Generator Voltage", selector: entitySelector },
                    { name: "aux_frequency", label: "Hoà lưới/Máy phát Tần số - AC PV/Generator Frequency", selector: entitySelector },
                    { name: "aux_power_l1", label: "Hoà lưới/Máy phát Công suất L1 - AC PV/Generator L1 Power", selector: entitySelector },
                    { name: "aux_power_l2", label: "Hoà lưới/Máy phát Công suất L2 - AC PV/Generator L2 Power", selector: entitySelector },
                    { name: "aux_power_l3", label: "Hoà lưới/Máy phát Công suất L3 - AC PV/Generator L3 Power", selector: entitySelector },
